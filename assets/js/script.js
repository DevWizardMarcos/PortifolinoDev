...
const projectProfiles = [
  { id: 'savory', category: 'front-end', phase: 'Legado', featured: true, year: '2024', role: 'Desenvolvimento Front-End', image: './assets/img/Projetos/Savory.png', demo:'https://devwizardmarcos.github.io/ReactSavory-/', github:'https://github.com/DevWizardMarcos/ReactSavory-' },
  ...
  { id: 'starbucks', category: 'front-end', phase: 'Legado', featured: false, year: '2025', role: 'Projeto Pessoal', image: './assets/img/Projetos/StartBucks.PNG', demo:'https://devwizardmarcos.github.io/Projeto-StarBucks-Old/', github:'https://github.com/DevWizardMarcos/Projeto-StarBucks-Old' },
  ...
  { id: 'deadpool', category: 'front-end', phase: 'Construção', featured: false, year: '2024', role: 'Desenvolvimento Front-End', image: './assets/img/Projetos/deadpoo.jpg', demo:'https://devwizardmarcos.github.io/Deadpool-Ultima-Aventura-O-Fim-do-Jogo/', github:'https://github.com/DevWizardMarcos/Deadpool-Ultima-Aventura-O-Fim-do-Jogo' },
  ...
  { id: 'horizon', category: 'front-end', phase: 'Construção', featured: false, year: '2025', role: 'Desenvolvimento Front-End', image: './assets/img/Projetos/horizon.png', demo:'https://devwizardmarcos.github.io/formuluariohorizon/', github:'https://github.com/DevWizardMarcos/formuluariohorizon' },
  { id: 'infinity-open', category: 'front-end', phase: 'Construção', featured: false, year: '2026', role: 'Desenvolvimento Front-End', image: './assets/img/Projetos/InfinityOpen.jpeg', demo:'https://devwizardmarcos.github.io/Infinity-Open-2026/', github:'https://github.com/DevWizardMarcos/Infinity-Open-2026' },
  { id: 'wayne', category: 'front-end', phase: 'Construção', featured: false, year: '2025', role: 'Desenvolvimento Front-End', image: './assets/img/Projetos/wayne.png', demo:'https://devwizardmarcos.github.io/Projeto_Wayne/', github:'https://github.com/DevWizardMarcos/Projeto_Wayne' }
];

// Fonte central de projetos. Novas relíquias exigem alteração apenas neste array.
const projects = [
  { id:'savory', title:'Savory', image:'./assets/img/Projetos/Savory.png', shortDescription:'Experiência gastronômica digital para descoberta e exploração de receitas.', challenge:'Organizar a descoberta de receitas em uma experiência visual clara, convidativa e fácil de explorar.', construction:'A interface foi construída com foco na apresentação do conteúdo gastronômico, na hierarquia visual e na navegação responsiva.', legacy:'O projeto consolidou uma experiência digital com identidade própria para apresentar e explorar conteúdo gastronômico.', technologies:['React 18','React Router','Vite','Node.js','CSS'], contributions:['Interface','Responsividade'], category:'front-end', categoryLabel:'Front-End', chapter:'Capítulo IV', phase:'Legado', year:2024, role:'Desenvolvimento Front-End', roleDescription:'Atuação no desenvolvimento da interface e da estrutura da experiência web.', accentColor:'#c69645', status:'completed', github:'https://github.com/DevWizardMarcos/ReactSavory-', demo:'https://devwizardmarcos.github.io/ReactSavory-/', featured:true, featuredOrder:1, icon:'&#8734;' },
  ...
  { id:'starbucks', title:'StarBucks', image:'./assets/img/Projetos/StartBucks.PNG', shortDescription:'Página temática inspirada na identidade visual da Starbucks.', challenge:'Revisitar um dos primeiros projetos e melhorar sua organização visual.', solution:'A página usa HTML e CSS para explorar hierarquia, espaçamento e destaque do produto.', technologies:['HTML','CSS'], technicalHighlights:['Composição visual','Fundamentos de HTML e CSS'], category:'front-end', categoryLabel:'Front-End', phase:'Legado', year:2025, role:'Desenvolvimento Front-End', roleDescription:'Criação da estrutura HTML e da composição visual em CSS.', status:'completed', github:'https://github.com/DevWizardMarcos/Projeto-StarBucks-Old', demo:'https://devwizardmarcos.github.io/Projeto-StarBucks-Old/', featured:false, featuredOrder:null, icon:'&#9826;' },
  ...
  { id:'deadpool', title:'Deadpool', image:'./assets/img/Projetos/deadpoo.jpg', shortDescription:'Página temática com direção visual inspirada no personagem Deadpool.', challenge:'Traduzir uma referência visual forte em uma experiência web funcional e responsiva.', solution:'A interface foi organizada em torno de contraste, hierarquia visual e componentes interativos.', technologies:['HTML5','CSS3','Bootstrap 5.3','JavaScript'], technicalHighlights:['Página temática','Interações nativas'], category:'front-end', categoryLabel:'Front-End', phase:'Construção', year:2024, role:'Desenvolvimento Front-End', roleDescription:'Atuação na criação da identidade visual e das interações da página.', status:'completed', github:'https://github.com/DevWizardMarcos/Deadpool-Ultima-Aventura-O-Fim-do-Jogo', demo:'https://devwizardmarcos.github.io/Deadpool-Ultima-Aventura-O-Fim-do-Jogo/', featured:false, featuredOrder:null, icon:'&#9826;' },
  ...
  { id:'horizon', title:'Horizon', image:'./assets/img/Projetos/horizon.png', shortDescription:'Interface de login inspirada em Horizon Zero Dawn, com vídeo de fundo e efeitos CSS.', challenge:'Construir uma página temática com presença visual sem perder usabilidade.', solution:'O formulário combina campos nativos, painel translúcido, vídeo de fundo e animações CSS.', technologies:['HTML5','CSS3'], technicalHighlights:['Direção visual','Layout adaptável'], category:'front-end', categoryLabel:'Front-End', phase:'Construção', year:2025, role:'Desenvolvimento Front-End', roleDescription:'Atuação na estruturação da página e na implementação visual.', status:'completed', github:'https://github.com/DevWizardMarcos/formuluariohorizon', demo:'https://devwizardmarcos.github.io/formuluariohorizon/', featured:false, featuredOrder:null, icon:'&#9826;' },
  { id:'infinity-open', title:'Infinity Open', image:'./assets/img/Projetos/InfinityOpen.jpeg', shortDescription:'Landing page temática de evento com programação, contagem regressiva e formulário integrado ao WhatsApp.', challenge:'Apresentar uma proposta tecnológica de forma acessível e visualmente consistente.', solution:'A solução organiza o conteúdo em uma página responsiva com hierarquia e navegação claras.', technologies:['HTML5','CSS3','JavaScript','Bootstrap 5.3'], technicalHighlights:['Programação do evento','Formulário condicional','Layout responsivo'], category:'front-end', categoryLabel:'Front-End', phase:'Construção', year:2026, role:'Desenvolvimento Front-End', roleDescription:'Atuação na construção da interface e na apresentação do conteúdo.', status:'completed', github:'https://github.com/DevWizardMarcos/Infinity-Open-2026', demo:'https://devwizardmarcos.github.io/Infinity-Open-2026/', featured:false, featuredOrder:null, icon:'&#9826;' },
  { id:'wayne', title:'Wayne', image:'./assets/img/Projetos/wayne.png', shortDescription:'Experiência temática das Indústrias Wayne com acesso demonstrativo, dashboard e coleção de Batmóveis.', challenge:'Criar uma experiência temática reconhecível com boa adaptação para diferentes telas.', solution:'O projeto utiliza composição visual, tipografia e interações simples para reforçar sua identidade.', technologies:['HTML5','CSS3','JavaScript','Bootstrap 5','PHP (auxiliar)'], technicalHighlights:['Dashboard interativo','Coleção de Batmóveis','Importação e exportação JSON'], category:'front-end', categoryLabel:'Front-End', phase:'Construção', year:2025, role:'Desenvolvimento Front-End', roleDescription:'Atuação na criação da interface e na composição visual da experiência.', status:'completed', github:'https://github.com/DevWizardMarcos/Projeto_Wayne', demo:'https://devwizardmarcos.github.io/Projeto_Wayne/', featured:false, featuredOrder:null, icon:'&#9826;' },
  { id:'projeto-choronos', title:'Projeto Choronos', image:null, shortDescription:'Aplicação Pomodoro para organização de ciclos de foco e descanso.', technologies:['React 19','TypeScript','Vite','CSS'], category:'front-end', categoryLabel:'Front-End', phase:'Registro', year:'—', role:'Desenvolvimento Front-End', roleDescription:'Projeto desenvolvido com React e o ecossistema Vite.', status:'completed', github:'https://github.com/DevWizardMarcos/Projeto-Choronos-Pomodoro', demo:null, featured:false, featuredOrder:null, icon:'&#9201;' },
  { id:'aulas-flex', title:'Aulas Flex', image:null, shortDescription:'Projeto para organização e gerenciamento de aulas.', technologies:['Python','SQLite','SQL'], category:'back-end', categoryLabel:'Back-End', phase:'Registro', year:'—', role:'Desenvolvimento Back-End', roleDescription:'Projeto desenvolvido com Python e banco de dados relacional.', status:'completed', github:'https://github.com/DevWizardMarcos/Aulas-flex-com-o-Instrutor-Ms-', demo:null, featured:false, featuredOrder:null, icon:'&#9776;' },
  { id:'api-financeira-python', title:'API Financeira Python', image:'./assets/img/Projetos/API.png', shortDescription:'Aplicação Streamlit que consulta cotações na AwesomeAPI com Python e Requests.', technologies:['Python','Streamlit','Requests','CSS'], category:'back-end', categoryLabel:'Back-End', phase:'Registro', year:'—', role:'Desenvolvimento Back-End', roleDescription:'Interface em Streamlit e consumo de uma API externa com Requests.', status:'completed', github:'https://github.com/DevWizardMarcos/Projeto-API-financeira-Python', demo:null, featured:false, featuredOrder:null, icon:'&#36;' },
  { id:'projeto-pizzaria', title:'Projeto Pizzaria', image:null, shortDescription:'Front-end de um sistema para pizzaria; o README descreve um backend FastAPI separado.', technologies:['React 19','React Router','Vite','CSS'], category:'front-end', categoryLabel:'Front-End', phase:'Registro', year:'—', role:'Desenvolvimento Front-End', roleDescription:'Repositório da interface React; implementação do backend não incluída neste código.', status:'completed', github:'https://github.com/DevWizardMarcos/Projeto_Pizzaria', demo:null, featured:false, featuredOrder:null, icon:'&#9673;' },
  { id:'dashboard-dados-reais', title:'Dashboard de Dados Reais', image:null, shortDescription:'Dashboard para apresentação e visualização de dados reais.', technologies:['React 19','TypeScript','Vite','Tailwind CSS 4'], category:'front-end', categoryLabel:'Front-End', phase:'Registro', year:'—', role:'Desenvolvimento Front-End', roleDescription:'Interface de dados desenvolvida com React e TypeScript.', status:'completed', github:'https://github.com/DevWizardMarcos/Dashboard-de-dados-reais', demo:null, featured:false, featuredOrder:null, icon:'&#9638;' },
  { id:'game-project-if', title:'Game Project IF', image:null, shortDescription:'Projeto de jogo construído com tecnologias web.', technologies:['Node.js','Express','HTML','CSS','JavaScript'], category:'full-stack', categoryLabel:'Full-Stack', phase:'Registro', year:'—', role:'Desenvolvimento Web', roleDescription:'Projeto desenvolvido com JavaScript, Node.js, HTML e CSS.', status:'completed', github:'https://github.com/DevWizardMarcos/Game-project-IF', demo:null, featured:false, featuredOrder:null, icon:'&#9823;' },
...
const spellDomains = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: 'Node.js', rank: 'Experiência sólida', description: 'Serviços JavaScript, integrações e suporte a aplicações full-stack.', projects: ['Game Project IF'] }
    ]
  },
  {
    ...
    technologies: [
      ...
      { name: 'MongoDB', rank: 'Em evolução', description: 'Estruturas documentais e dados flexíveis em experiências full-stack.', projects: [] }
    ]
  },
  {
